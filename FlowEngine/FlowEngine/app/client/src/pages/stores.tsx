      ...
      <div className="flex-1 overflow-auto">
        <div className="p-8">
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              <h1 className="text-3xl font-bold text-dark-color mb-2">{t('stores')}</h1>
              <p className="text-secondary-color">{t('manageStoresDesc')}</p>
            </div>
                    ...
                    <TableRow key={store.id}>
                      ...
                      <TableCell>
                        <div className="flex gap-2">
                          ...
                          <Button variant="outline" size="sm" data-testid={`button-delete-store-${store.id}`}>
